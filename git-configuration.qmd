...
```{r}
library(usethis)
use_git_config(user.name = "dheimgartner", user.email = "d.heimgartners@gmail.com")  # mail used on GitHub... (daniel.heimgartner@ivt.baug.ethz.ch used for course registration)
```
